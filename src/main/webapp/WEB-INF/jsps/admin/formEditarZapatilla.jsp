...
<p
		class="text-lg text-center font-bold m-[3rem] text-[2rem] text-white">Editar zapatilla</p>

<div class="flex justify-center w-full">
	<springform:form modelAttribute="zapatilla" action="actualizarZapatilla" enctype="multipart/form-data" cssClass="flex flex-col text-white bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r w-fit p-3 rounded-lg text-[1.5rem]">
	<label class="m-2 flex justify-end items-center"> Id:
	 <springform:input cssClass="text-[#000000] ml-[1rem] rounded-md px-2 py-1" path="id"/>
	</label>
